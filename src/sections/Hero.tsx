    ...
    <section ref={heroRef} className="pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#183EC2,#EAEEFE_100%)] overflow-x-clip">
      <div className="container">
        ...
        <div className="md:w-[478px]">
          <div className="text-sm inline-flex border border-[#222]/10 px-3 py-1 rounded-lg tracking-tight">Version 3.0 is here</div>
        ...
        <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
          ...
          />
          <motion.img 
          src={cylinderImage.src} width={220} height={220} alt="cyl-img" 
          ...
          />
          <motion.img 
          src={noodleImg.src} alt="noodle" width={220} className="hidden lg:block absolute top-[524px] left-[448px] rotate-[30deg]" 
          style={{
            rotate: 30,
            translateY: translateY,
          }}
